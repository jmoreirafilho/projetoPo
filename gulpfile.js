...
gulp.task('templates', function() {
  ...
  gulp.src(['./app/shared/**/*.html','./app/shared/**/**/**/*.html'])
    .pipe(htmlmin({collapseWhitespace: true}))
    .pipe(flatten())
    .pipe(gulp.dest('./www/assets/pages/templates'));
});
...
gulp.task('uglify', function(){
	var tsResults = gulp.src(tsCompile)
...
gulp.task('clean-css', function() {
  ...
  gulp.src('./www/assets/css/semantic/**/*')
    ...
    gulp.src('./www/assets/css/realperson/**/*')
    .pipe(gulp.dest('./build/assets/styles/realperson'))
});
...
gulp.task('watch', ['serve'], function() {
  ...
  gulp.watch('app/shared/**/*.html', ['templates']);
